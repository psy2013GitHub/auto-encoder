...
[saeSoftmaxOptTheta, costSoftmax] = minFunc( @(p) softmaxCost(p, numClasses, ...
...
[stackedAEOptTheta, coststackedAESoftmax] = minFunc( @(p) stackedAECost(p, inputSize, ...
                              hiddenSizeL2, numClasses, netconfig, lambda, sparsityParam, beta, trainData, trainLabels), ...
